...
const CTA = () => {
  return (
    <div className='my-8 p-8 bg-gray-100 dark:bg-neutral-900 md:rounded-lg shadow-[0_1px_1px_rgba(0,0,0,0.05),0_4px_6px_rgba(34,42,53,0.04),0_24px_68px_rgba(47,48,55,0.05),0_2px_3px_rgba(0,0,0,0.04)]'>
      ...
      <div className='text-zinc-700 dark:text-zinc-400 flex gap-2'>👉 <CTALink href={'mailto:ritikjaiswal148@gmail.com'} text={'Email me'} /> or <CTALink href={'https://x.com/RitikJa62967785'} text={'DM me'} /></div>
    </div>
  )
}
