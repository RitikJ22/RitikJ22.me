...
const Card = ({ project }: { project: Project }) => {
  return (
    <Link href={project.link || ""} target="_blank">
      <div className="flex flex-col justify-between p-6 rounded-lg border dark:border-neutral-700 border-neutral-300 shadow-[0_1px_1px_rgba(0,0,0,0.05),0_4px_6px_rgba(34,42,53,0.04),0_24px_68px_rgba(47,48,55,0.05),0_2px_3px_rgba(0,0,0,0.04)] relative h-full transition-transform duration-300 ease-in-out hover:scale-103">
        <div>
